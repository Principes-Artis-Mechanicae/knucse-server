package com.knucse.locker.api.locker.apply._executive;
...
public class ApplyExecutiveController {
	...
	public ResponseEntity<ApiSuccessResult<List<ApplyReadDto>>> getAppliesByYearAndSemester(
		...
		return ResponseEntity
			...
			.body(ApiResponseUtil.success(HttpStatus.OK, applies));
	}
	...
	@ApiResponses(value = {
		@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "신청 목록 조회 성공"),
		@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "신청 폼을 찾을 수 없음 (code: APPLY_FORM_NOT_FOUND)"),
		@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "신고 기록을 찾을 수 없음 (code: REPORT_NOT_FOUND)")
	})
	...
	@ApiResponses(value = {
		@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "신청 수정 성공"),
	...
	public ResponseEntity<ApiSuccessResult<ApplyReadDto>> updateApplyByStudentNumber(
		...
		return ResponseEntity
			.status(HttpStatus.OK)
			.body(ApiResponseUtil.success(HttpStatus.OK, updatedApply));
	}
	...
	@ApiResponses(value = {
		@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "204", description = "신청 삭제 성공"),
		@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "신청을 찾을 수 없음 (code: APPLY_NOT_FOUND)"),
		@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "신청 폼을 찾을 수 없음 (code: APPLY_FORM_NOT_FOUND)"),
		@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "학생을 찾을 수 없음 (code: STUDENT_NOT_FOUND)")
	})
